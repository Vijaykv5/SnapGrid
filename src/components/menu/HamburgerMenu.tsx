...
const HamburgerMenu : React.FC<Props> =({onClick,visibility})=>{
    ...
    return(
        <div className='flex w-10 h-10 flex-col items-center justify-evenly  xl:invisible lg:invisible md:invisible sm:visible xs:visible text-white' onClick={onClick} >
